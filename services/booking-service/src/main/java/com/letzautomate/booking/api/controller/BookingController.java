package com.letzautomate.booking.api.controller;
...
import com.letzautomate.booking.api.dto.LoyaltyAccrualResponse;
...
public class BookingController {
	...
	// Loyalty accrual information
	@GetMapping(value = "/{bookingId}/loyalty", produces = "application/json")
	public LoyaltyAccrualResponse getLoyaltyAccrual(@PathVariable UUID bookingId) {
		return bookingAppService.getLoyaltyAccrual(bookingId);
	}
